...
(function (t) {
  var e = (typeof self === "undefined" ? "undefined" : _typeof(self)) == "object" && self.self == self && self || (typeof global === "undefined" ? "undefined" : _typeof(global)) == "object" && global.global == global && global;if (typeof define === "function" && define.amd) {
    define('backbone',["underscore", "jquery", "exports"], function (i, r, n) {
  ...
  var n = t.Backbone;var s = Array.prototype.slice;e.VERSION = "1.2.3";e.$ = r;e.noConflict = function () {
    ...
    var a = 0,
        o;if (r && (typeof r === "undefined" ? "undefined" : _typeof(r)) === "object") {
    ...
    i = Math.min(Math.max(i, 0), t.length);var r = Array(t.length - i);var n = e.length;for (var s = 0; s < r.length; s++) {
      r[s] = t[s + i];
    }for (s = 0; s < n; s++) {
      t[s + i] = e[s];
 ...
 */(function (a, b) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) == "object" && typeof require == "function" ? module.exports = b(require("backbone")) : typeof define == "function" && define.amd ? define('localstorage',["backbone"], function (c) {
  ...
  function b() {
    ...
    if (a == null) return void 0;var c = a[b];return typeof c == "function" ? a[b]() : c;
  }return a.LocalStorage = window.Store = function (a, b) {
    if (!this.localStorage) throw "Backbone.localStorage: Environment does not support localStorage.";this.name = a, this.serializer = b || { serialize: function serialize(a) {
        return d(a) ? JSON.stringify(a) : a;
      }, deserialize: function deserialize(a) {
        return a && JSON.parse(a);
      } };var c = this.localStorage().getItem(this.name);this.records = c && c.split(",") || [];
  }, f(a.LocalStorage.prototype, { save: function save() {
      ...
      this.localStorage().setItem(this._itemName(a.id), this.serializer.serialize(a));var b = a.id.toString();return e(this.records, b) || (this.records.push(b), this.save()), this.find(a);
    }, find: function find(a) {
      return this.serializer.deserialize(this.localStorage().getItem(this._itemName(a.id)));
    }, findAll: function findAll() {
      var a = [];for (var b = 0, c, d; b < this.records.length; b++) {
        c = this.records[b], d = this.serializer.deserialize(this.localStorage().getItem(this._itemName(c))), d != null && a.push(d);
      }return a;
    }, destroy: function destroy(a) {
      this.localStorage().removeItem(this._itemName(a.id));var b = a.id.toString();for (var c = 0, d; c < this.records.length; c++) {
    ...
    var d = c && c.ajaxSync;return !d && (g(b, "localStorage") || g(b.collection, "localStorage")) ? a.localSync : a.ajaxSync;
...
define('collections/Users',['backbone', 'localstorage', 'models/User'], function (Backbone, localstorage, UserModel) {
...
define('views/users/UserItem',['backbone', 'underscore'], function (Backbone, _) {
...
define('views/users/UsersList',['backbone', 'underscore', 'collections/Users', 'views/users/UserItem'], function (Backbone, _, UsersCollection, UserItemView) {
...
define('views/users/UsersPage',['jquery', 'backbone', 'underscore', 'views/users/UsersList'], function ($, Backbone, _, UsersListView) {
...
define('text!views/users/templates/AddUser.html',[],function () { return '<% for (let attr for userAttrs) { %>\r\n<input name="name">\r\n<div class="action-button action-button--success">Submit</div>\r\n<% } %>';});



define('views/users/AddUser',['backbone', 'underscore', 'models/User', 'text!views/users/templates/AddUser.html'], function (Backbone, _, UserModel, AddUserTpl) {
...
define('router',['jquery', 'backbone', 'views/users/UsersPage', 'views/users/AddUser'], function ($, Backbone, UsersPageView, AddUserView) {
